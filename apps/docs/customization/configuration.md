...
- [Kysely Adapter](/customization/kysely/)
- [Drizzle Adapter](/customization/drizzle/)
- [Cloudflare Adapter](/customization/cloudflare-adapter/)
...
For detailed SAML configuration options, see the [SAML Package Documentation](/customization/saml/).
...
For more details and examples, see the [Hooks Guide — Custom Webhook Invoker](/features/hooks#custom-webhook-invoker).
...
::: tip
For detailed documentation about hooks, including Auth0 compatibility, URL/Form hooks, and complete API reference, see the [Hooks Documentation](/auth0-comparison/hooks).
:::
...
For complete hook documentation including all event data, API methods, and advanced use cases, see the [Hooks Documentation](/auth0-comparison/hooks).
...
- [Hooks Documentation](/auth0-comparison/hooks) - Complete guide to hooks including Auth0 compatibility
- [Kysely Adapter](/customization/kysely/)
- [Drizzle Adapter](/customization/drizzle/)
- [Cloudflare Adapter](/customization/cloudflare-adapter/)
